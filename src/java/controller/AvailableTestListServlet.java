 ...
 * @author csalas
 */
public class AvailableTestListServlet extends HttpServlet {
    @EJB
    ...
    private void redirectToTestList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
